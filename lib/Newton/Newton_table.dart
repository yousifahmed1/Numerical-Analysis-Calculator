...
import 'NewtonMethod.dart';

class NewtonTablePage extends StatelessWidget {
  final List<Map<String, dynamic>> iterations;
  final double lastXR; // Assuming lastXR is the last XR value

  NewtonTablePage({required this.iterations, required this.lastXR});
              ...
              DividerTheme(
                ...
                child: DataTable(
                  columns: [
                    ...
                    DataColumn(label: Text('f(Xid)', style: TextStyle(color: Colors.white, fontSize: 18))),
                  ...
                  rows: iterations.map((iteration) {
                    return DataRow(
                      cells: [
                        ...
                        DataCell(Text(iteration['fxid'].toString(), style: TextStyle(color: Colors.white, fontSize: 18))),
